...
\begin{document}
	...
	\begin{frame}[fragile]{Reduction FAST.1}
		...
		\begin{center}
		\uncover<1->{ \includegraphics[height=0.5\paperheight]{images/FAST_1/Triangle2.pdf} }
		\uncover<2>{ \includegraphics[height=0.5\paperheight]{images/FAST_1/Triangle2Rev.pdf} }
		\end{center}
	\end{frame}
